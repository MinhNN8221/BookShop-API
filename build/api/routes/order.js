...
orderRouter.get('/:orderId', _authenticate2.default, _orderController2.default.getOrderInfo);
orderRouter.get('/', _authenticate2.default, _orderController2.default.getMyOrders);
