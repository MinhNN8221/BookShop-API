...
exports.default = {
  ...
  createToken: function createToken(user) {
    ...
    return _jsonwebtoken2.default.sign({ customer_id: customerId, name: name, email: email }, process.env.SECRET, { expiresIn: 1296000 });
  },
  ...
  validateChangePass: function validateChangePass(user) {
    return _joi2.default.validate(user, _validationSchema2.default.changePassSchema, options);
  },
  validateForgotPass: function validateForgotPass(user) {
    return _joi2.default.validate(user, _validationSchema2.default.forgotPassSchema, options);
  },
  ...
  validateItemCartDetails: function validateItemCartDetails(user) {
    return _joi2.default.validate(user, _validationSchema2.default.shoppingItemCartSchema, options);
  },
  ...
  validateWishlistDetails: function validateWishlistDetails(user) {
    return _joi2.default.validate(user, _validationSchema2.default.wishlistSchema, options);
  },
